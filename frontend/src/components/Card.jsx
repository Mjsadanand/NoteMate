...
const Card = () => {
  return (
    <section className="relative group flex flex-col items-center justify-center w-full h-full">
      <div className="file relative w-72 h-52 cursor-pointer origin-bottom [perspective:1500px] z-10 group-hover:z-50">
